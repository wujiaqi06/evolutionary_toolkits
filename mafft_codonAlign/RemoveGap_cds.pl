...
my %opts;
getopts('i:o:d:t:c:', \%opts);
my $input_folder = $opts{'i'} or die "use: perl $0 -i Genome_folder -o output_folder -d deleting_rate -t fasta\/phy -c codon_table\n";
my $output_folder = $opts{'o'} or die "use: perl $0 -i Genome_folder -o output_folder -d deleting_rate -t fasta\/phy -c codon_table\n";
my $del_missing_value = $opts{'d'} or die "use: perl $0 -i Genome_folder -o output_folder -d deleting_rate -t fasta\/phy -c codon_table\n";
my $output_type = $opts{'t'} or die "use: perl $0 -i Genome_folder -o output_folder -d deleting_rate -t fasta\/phy -c codon_table\n";
my $codon_table = $opts{'c'} or die "use: perl $0 -i Genome_folder -o output_folder -d deleting_rate -t fasta\/phy -c codon_table\n";
